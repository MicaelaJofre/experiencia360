...
export function ChangeMap(data) {
    ...
    // timbre de las flechas
    let arrowsContainer = document.querySelector('#arrowsContainer')
    arrowsContainer.components.sound.playSound();
    ...
    if (data.img === '#living' ) {
        ...
        //flechas
        cavaContainer.firstChild.nextSibling.setAttribute("class", "click")
        cavaContainer.setAttribute('visible', 'true')
        
        livingContainer.firstChild.nextSibling.classList.remove("click")
    ...
    if (data.img === '#cava') {
        ...
        //flechas
        cavaContainer.firstChild.nextSibling.classList.remove("click")
        cavaContainer.setAttribute('visible', 'false')

        livingContainer.firstChild.nextSibling.setAttribute("class", "click")
